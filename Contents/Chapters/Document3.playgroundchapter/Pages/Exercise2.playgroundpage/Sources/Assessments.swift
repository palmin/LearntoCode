...
public func assessmentPoint() -> AssessmentResults {
    ...
    var success = "### Excellent! \nNow you know how to add a loop structure into your code. You'll need this in the next puzzle! \n\n[Next Page](@next)"
    var hints = [
        "Open the code library by tapping the + button at the top of the screen, then drag out a `for` loop.",
        "The basic sequence is for Byte to collect the gem, move forward three times, then turn right for each side of the square."
    ]
