...
let hints = [
    "As you did in the previous puzzles, [initialize](glossary://initialize) your character and expert first. Then call [methods](glossary://method) on those [instances](glossary://instance) to solve the puzzle.",
