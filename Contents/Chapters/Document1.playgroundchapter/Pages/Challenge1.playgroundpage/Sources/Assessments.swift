...
public func assessmentPoint() -> AssessmentResults {
    ...
    } else if checker.functionCallCount(forName: "toggleSwitch") > 0 && checker.functionCallCount(forName: "collectGem") == 0 {
    ...
    } else if checker.functionCallCount(forName: "toggleSwitch") > 0 && checker.functionCallCount(forName: "collectGem") > 0 && checker.numberOfStatements < 13 {
