...
public func assessmentPoint() -> AssessmentResults {
    ...
    if checker.numberOfStatements < 9 {
        ...
        hints[0] = "You're on the right track, but there might be a shorter way to solve the puzzle. The portals are color-coded: blue goes to blue and green goes to green. Try again using the green portals for your solution, or feel free to move on. \n\n[Introduction to Functions.](Functions/Introduction)"
