...
public func assessmentPoint() -> AssessmentResults {
    ...
    var hints = [
        "Sometimes a bug is just one out-of-place command. Think about which commands, in which order, will get you to the switch and the gem. Can you move one command to make that happen?",
    ...
    if checker.calledFunctions == defaultContents {
        ...
        hints[0] = "Adding more commands might not help here. Try rearranging your existing code by tapping on a command to select it, then drag it to a new location."
