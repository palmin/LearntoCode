...
func generateRandomCoordinates() -> [Coordinate] {
    ...
    let randomIndex = arc4random_uniform(UInt32(platformArray.count))
    
    let randomPlatformPositions = platformArray[Int(randomIndex)]
...
func placeBlocks(placedCoordinates: [Coordinate]) {
    ...
    world.removeNodes(at: obstacleArray)
