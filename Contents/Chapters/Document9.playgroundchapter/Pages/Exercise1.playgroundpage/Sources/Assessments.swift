...
let hints = [
"Declare a new variable by tapping `var` in the shortcut bar and give the variable a name, then use the [assignment operator](glossary://assigment%20operator) (=) to set the variable's value. Example: `var highScore = 105`.",
