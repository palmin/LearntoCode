...
public func assessmentPoint() -> AssessmentResults {
    ...
    var success = "### Your function skills are growing! \nYou're actually writing your own functions! Functions let you make complicated actions simpler and easier to perform. \n\n[Next Page](@next)"

    var hints = [
        "Your [function](glossary://function) should first collect a gem, then move forward, then toggle a switch.",
        "You'll need to use your function in several different places around the world in this challenge.",
        ]
    ...
    if checker.didUseForLoop || checker.didUseWhileLoop {
        ...
        success = " ### Congrats! \nYou solved the puzzle, but you used \(checker.calledFunctions.count) commands! Try defining your own [function](glossary://function) using `func name() {}`, and call it to solve the puzzle. You won't need to use as many commands, and your code will be easier to read. You can also go to the [Next Page](@next) if you like."
...
//
//else if commandQueue.containsIncorrectPickUpCommand() {
