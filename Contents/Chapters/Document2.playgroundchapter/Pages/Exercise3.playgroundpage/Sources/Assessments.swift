...
public func assessmentPoint() -> AssessmentResults {
    ...
    var success = "### Incredible job! \nYou’ve broken a large problem into smaller, more manageable pieces. This process is called **[decomposition](glossary://decomposition)**. Combining functions to solve a big problem is called **composition**. \nCongratulations, you're becoming a great problem solver! \n\n[Next Page](@next)"
    var hints = [
    ...
    if checker.functionCallCount(forName: "solveStair") == 0 && checker.functionCallCount(forName: "turnAround") > 0 {
    ...
    } else if checker.numberOfStatements > 16 {
        ...
        hints[0] = "Try defining the `solveStair()` function to decrease the number of commands you need."
    }
