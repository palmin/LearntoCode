...
public func assessmentPoint() -> AssessmentResults {
    ...
    var hints = [
        ...
        "Each time you move Byte forward, check for a gem. If a gem is present, turn left and move forward.",
        ]
    ...
    if !checker.didUseConditionalStatement("if") {
        ...
        hints[0] = "Inside your `if` statement, check whether Byte is on a gem. If so, turn left and move forward."
    }
