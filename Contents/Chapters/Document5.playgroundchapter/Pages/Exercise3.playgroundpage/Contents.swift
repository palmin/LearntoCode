...
In this puzzle, there are 12 random locations where Byte can collect a gem or toggle open a switch. Watch the wireframes when you run the puzzle—they show the possible items that might appear.
